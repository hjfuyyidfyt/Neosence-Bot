export const messages = {
  en: {
    ...
    menu: {
      ...
      balance: "💰 Balance",
      freelancerMode: "Mode: Freelancer",
      buyerMode: "Mode: Buyer",
      profile: "👤 Profile",
      support: "🛟 Support",
    ...
    taskWizard: {
      ...
      instructionOrTemplate: "Send custom instruction, or press Use Template.",
...
const banglaMessages: MessageBundle = {
  ...
  menu: {
    ...
    submissions: "🧾 সাবমিশন",
    balance: "💰 ব্যালেন্স",
    freelancerMode: "মোড: ফ্রিল্যান্সার",
    buyerMode: "মোড: বায়ার",
    profile: "👤 প্রোফাইল",
    support: "🛟 সাপোর্ট",
    earnMoney: "💼 আয় করুন",
  ...
  taskWizard: {
    ...
    instructionOrTemplate: "কাস্টম ইনস্ট্রাকশন পাঠান, অথবা Template ব্যবহার করুন।",
    templateReadyTitle: "🧾 ইনস্ট্রাকশন টেমপ্লেট",
